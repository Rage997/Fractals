...
void main() {
	...
	`}function gA(s){let e=new WeakMap,i=null;function r(h){if(h&&h.isTexture){const m=h.mapping,p=m===mh||m===gh,v=m===Fr||m===Is;if(p||v){let _=e.get(h);const S=_!==void 0?_.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==S)return i===null&&(i=new q_(s)),_=p?i.fromEquirectangular(h,_):i.fromCubemap(h,_),_.texture.pmremVersion=h.pmremVersion,e.set(h,_),_.texture;if(_!==void 0)return _.texture;{const M=h.image;return p&&M&&M.height>0||v&&M&&l(M)?(i===null&&(i=new q_(s)),_=p?i.fromEquirectangular(h):i.fromCubemap(h),_.texture.pmremVersion=h.pmremVersion,e.set(h,_),h.addEventListener("dispose",c),_.texture):null}}}return h}function l(h){let m=0;const p=6;for(let v=0;v<p;v++)h[v]!==void 0&&m++;return m===p}function c(h){const m=h.target;m.removeEventListener("dispose",c);const p=e.get(m);p!==void 0&&(e.delete(m),p.dispose())}function f(){e=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:r,dispose:f}}function _A(s){const e={};function i(r){if(e[r]!==void 0)return e[r];const l=s.getExtension(r);return e[r]=l,l}return{has:function(r){return i(r)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(r){const l=i(r);return l===null&&tl("WebGLRenderer: "+r+" extension not supported."),l}}}function vA(s,e,i,r){const l={},c=new WeakMap;function f(_){const S=_.target;S.index!==null&&e.remove(S.index);for(const E in S.attributes)e.remove(S.attributes[E]);S.removeEventListener("dispose",f),delete l[S.id];const M=c.get(S);M&&(e.remove(M),c.delete(S)),r.releaseStatesOfGeometry(S),S.isInstancedBufferGeometry===!0&&delete S._maxInstanceCount,i.memory.geometries--}function h(_,S){return l[S.id]===!0||(S.addEventListener("dispose",f),l[S.id]=!0,i.memory.geometries++),S}function m(_){const S=_.attributes;for(const M in S)e.update(S[M],s.ARRAY_BUFFER)}function p(_){const S=[],M=_.index,E=_.attributes.position;let T=0;if(M!==null){const D=M.array;T=M.version;for(let N=0,O=D.length;N<O;N+=3){const L=D[N+0],I=D[N+1],F=D[N+2];S.push(L,I,I,F,F,L)}}else if(E!==void 0){const D=E.array;T=E.version;for(let N=0,O=D.length/3-1;N<O;N+=3){const L=N+0,I=N+1,F=N+2;S.push(L,I,I,F,F,L)}}else return;const g=new(Yv(S)?$v:Jv)(S,1);g.version=T;const x=c.get(_);x&&e.remove(x),c.set(_,g)}function v(_){const S=c.get(_);if(S){const M=_.index;M!==null&&S.version<M.version&&p(_)}else p(_);return c.get(_)}return{get:h,update:m,getWireframeAttribute:v}}function xA(s,e,i){let r;function l(S){r=S}let c,f;function h(S){c=S.type,f=S.bytesPerElement}function m(S,M){s.drawElements(r,M,c,S*f),i.update(M,r,1)}function p(S,M,E){E!==0&&(s.drawElementsInstanced(r,M,c,S*f,E),i.update(M,r,E))}function v(S,M,E){if(E===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(r,M,0,c,S,0,E);let g=0;for(let x=0;x<E;x++)g+=M[x];i.update(g,r,1)}function _(S,M,E,T){if(E===0)return;const g=e.get("WEBGL_multi_draw");if(g===null)for(let x=0;x<S.length;x++)p(S[x]/f,M[x],T[x]);else{g.multiDrawElementsInstancedWEBGL(r,M,0,c,S,0,T,0,E);let x=0;for(let D=0;D<E;D++)x+=M[D]*T[D];i.update(x,r,1)}}this.setMode=l,this.setIndex=h,this.render=m,this.renderInstances=p,this.renderMultiDraw=v,this.renderMultiDrawInstances=_}function SA(s){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function r(c,f,h){switch(i.calls++,f){case s.TRIANGLES:i.triangles+=h*(c/3);break;case s.LINES:i.lines+=h*(c/2);break;case s.LINE_STRIP:i.lines+=h*(c-1);break;case s.LINE_LOOP:i.lines+=h*c;break;case s.POINTS:i.points+=h*c;break;default:Ct("WebGLInfo: Unknown draw mode:",f);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:r}}function yA(s,e,i){const r=new WeakMap,l=new rn;function c(f,h,m){const p=f.morphTargetInfluences,v=h.morphAttributes.position||h.morphAttributes.normal||h.morphAttributes.color,_=v!==void 0?v.length:0;let S=r.get(h);if(S===void 0||S.count!==_){let U=function(){j.dispose(),r.delete(h),h.removeEventListener("dispose",U)};var M=U;S!==void 0&&S.texture.dispose();const E=h.morphAttributes.position!==void 0,T=h.morphAttributes.normal!==void 0,g=h.morphAttributes.color!==void 0,x=h.morphAttributes.position||[],D=h.morphAttributes.normal||[],N=h.morphAttributes.color||[];let O=0;E===!0&&(O=1),T===!0&&(O=2),g===!0&&(O=3);let L=h.attributes.position.count*O,I=1;L>e.maxTextureSize&&(I=Math.ceil(L/e.maxTextureSize),L=e.maxTextureSize);const F=new Float32Array(L*I*4*_),j=new jv(F,L,I,_);j.type=Hi,j.needsUpdate=!0;const w=O*4;for(let V=0;V<_;V++){const se=x[V],ae=D[V],me=N[V],de=L*I*4*V;for(let z=0;z<se.count;z++){const H=z*w;E===!0&&(l.fromBufferAttribute(se,z),F[de+H+0]=l.x,F[de+H+1]=l.y,F[de+H+2]=l.z,F[de+H+3]=0),T===!0&&(l.fromBufferAttribute(ae,z),F[de+H+4]=l.x,F[de+H+5]=l.y,F[de+H+6]=l.z,F[de+H+7]=0),g===!0&&(l.fromBufferAttribute(me,z),F[de+H+8]=l.x,F[de+H+9]=l.y,F[de+H+10]=l.z,F[de+H+11]=me.itemSize===4?l.w:1)}}S={count:_,texture:j,size:new Xt(L,I)},r.set(h,S),h.addEventListener("dispose",U)}if(f.isInstancedMesh===!0&&f.morphTexture!==null)m.getUniforms().setValue(s,"morphTexture",f.morphTexture,i);else{let E=0;for(let g=0;g<p.length;g++)E+=p[g];const T=h.morphTargetsRelative?1:1-E;m.getUniforms().setValue(s,"morphTargetBaseInfluence",T),m.getUniforms().setValue(s,"morphTargetInfluences",p)}m.getUniforms().setValue(s,"morphTargetsTexture",S.texture,i),m.getUniforms().setValue(s,"morphTargetsTextureSize",S.size)}return{update:c}}function MA(s,e,i,r){let l=new WeakMap;function c(m){const p=r.render.frame,v=m.geometry,_=e.get(m,v);if(l.get(_)!==p&&(e.update(_),l.set(_,p)),m.isInstancedMesh&&(m.hasEventListener("dispose",h)===!1&&m.addEventListener("dispose",h),l.get(m)!==p&&(i.update(m.instanceMatrix,s.ARRAY_BUFFER),m.instanceColor!==null&&i.update(m.instanceColor,s.ARRAY_BUFFER),l.set(m,p))),m.isSkinnedMesh){const S=m.skeleton;l.get(S)!==p&&(S.update(),l.set(S,p))}return _}function f(){l=new WeakMap}function h(m){const p=m.target;p.removeEventListener("dispose",h),i.remove(p.instanceMatrix),p.instanceColor!==null&&i.remove(p.instanceColor)}return{update:c,dispose:f}}const EA={[Lv]:"LINEAR_TONE_MAPPING",[Nv]:"REINHARD_TONE_MAPPING",[Ov]:"CINEON_TONE_MAPPING",[Pv]:"ACES_FILMIC_TONE_MAPPING",[zv]:"AGX_TONE_MAPPING",[Iv]:"NEUTRAL_TONE_MAPPING",[Fv]:"CUSTOM_TONE_MAPPING"};function bA(s,e,i,r,l){const c=new ki(e,i,{type:s,depthBuffer:r,stencilBuffer:l}),f=new ki(e,i,{type:Ma,depthBuffer:!1,stencilBuffer:!1}),h=new Ui;h.setAttribute("position",new Sa([-1,3,0,-1,-1,0,3,-1,0],3)),h.setAttribute("uv",new Sa([0,2,0,0,2,0],2));const m=new vb({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`].filter(Qo).join(`
`)),f=ep(f),f=rv(f,i),f=sv(f,i),h=ep(h),h=rv(h,i),h=sv(h,i),f=ov(f),h=ov(h),i.isRawShaderMaterial!==!0&&(D=`#version 300 es
